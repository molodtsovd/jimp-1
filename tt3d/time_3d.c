...
#pragma omp threadprivate(nmesh_x,nmesh_y,nmesh_z,hs,hs_buf,hs_keep,nx,ny,nz,\
	t,t_buf,timeshift,fxs,fys,fzs,xs,ys,zs,messages,source_at_node,init_stage,\
	current_side_limit,X0,X1,Y0,Y1,Z0,Z1,reverse_order,longflags,flag_fb,\
	x_start_fb,y_start_fb,z_start_fb,flag_bf,x_start_bf,y_start_bf,z_start_bf,\
	flag_ff,x_start_ff,y_start_ff,z_start_ff,flag_bb,x_start_bb,y_start_bb,\
	z_start_bb,hs_eps_init)
