...
#pragma omp threadprivate(nmesh_x,nmesh_y,hs_buf,hs,hs_keep,eps_init,nx,ny,t_buf,\
			  t,timeshift,fxs,fys,xs,ys,init_stage,source_at_node,\
			  reverse_order,current_side_limit,X0,X1,Y0,Y1,messages)
